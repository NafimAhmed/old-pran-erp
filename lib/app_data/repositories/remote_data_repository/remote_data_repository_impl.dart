...
class RemoteDataRepositoryImpl
  ...
  Future<ProdBatchDataResponse> getUserBatchData({
    ...
    var request = http.Request(
      'GET',
      Uri.parse(
          '${appConfig.baseUrl}/ords/rpro/batch/prodBatchData?userid=$userid&orgid=$orgid&job_order_no=$jobOrderNo'),
    );
  ...
  @override
  Future<OperationUnitListResponse> getOperationUnit() async {
    var request = http.Request(
  ...
  @override
  Future<GrnPOListResponse> getGrnPOList({required String jobOrderNo}) async {
    var request = http.Request(
        'GET',
        Uri.parse(
  ...
  @override
  Future<GrnJoListResponse> getGrnJOList({required String reqNo}) async {
    var request = http.Request('GET',
  ...
  @override
  Future<GrnOrgListResponse> getGrnOrgList({required int ouId}) async {
    var request = http.Request('GET',
  ...
  @override
  Future<MOReqListResponse> getMOReqList({required String userId}) async {
    var request = http.Request(
        'GET',
        Uri.parse(
