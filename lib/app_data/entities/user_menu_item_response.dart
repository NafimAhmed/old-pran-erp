...
class UserMenuItemResponse {
  ...
  factory UserMenuItemResponse.fromJson(String str) =>
      UserMenuItemResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory UserMenuItemResponse.fromMap(Map<String, dynamic> json) =>
      UserMenuItemResponse(
        statusCode: json["status_code"],
        message: json["message"],
        errmsg: json["errmsg"],
        userMenuItems: json["user_menu_items"] == null
            ? []
            : List<UserMenuItem>.from(
                json["user_menu_items"]!.map((x) => UserMenuItem.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "message": message,
        "errmsg": errmsg,
        "user_menu_items": userMenuItems == null
            ? []
            : List<dynamic>.from(userMenuItems!.map((x) => x.toMap())),
      };
}
...
class UserMenuItem {
  ...
  factory UserMenuItem.fromJson(String str) =>
      UserMenuItem.fromMap(json.decode(str));
  ...
  factory UserMenuItem.fromMap(Map<String, dynamic> json) => UserMenuItem(
        ...
        userPmenuItems: json["user_pmenu_items"] == null
            ? []
            : List<UserPmenuItem>.from(
                json["user_pmenu_items"]!.map((x) => UserPmenuItem.fromMap(x))),
      );

  Map<String, dynamic> toMap() => {
        "module_name": moduleName,
        "module_route": moduleRoute,
        "user_pmenu_items": userPmenuItems == null
            ? []
            : List<dynamic>.from(userPmenuItems!.map((x) => x.toMap())),
      };
}
...
class UserPmenuItem {
  ...
  factory UserPmenuItem.fromJson(String str) =>
      UserPmenuItem.fromMap(json.decode(str));
  ...
  factory UserPmenuItem.fromMap(Map<String, dynamic> json) => UserPmenuItem(
        ...
        userCmenuItems: json["user_cmenu_items"] == null
            ? []
            : List<UserCmenuItem>.from(
                json["user_cmenu_items"]!.map((x) => UserCmenuItem.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "user_cmenu_items": userCmenuItems == null
            ? []
            : List<dynamic>.from(userCmenuItems!.map((x) => x.toMap())),
      };
}
...
class UserCmenuItem {
  ...
  factory UserCmenuItem.fromJson(String str) =>
      UserCmenuItem.fromMap(json.decode(str));
