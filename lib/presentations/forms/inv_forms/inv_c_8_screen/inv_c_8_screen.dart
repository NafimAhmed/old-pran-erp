...
class InvC8Screen extends StatelessWidget {
  const InvC8Screen({super.key, required this.fromName});
  static const String routeName = "INV-C-8-SCREEN";
  static const String routePath = "/INV-C-8-SCREEN";
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => EbsInterOrgTranBloc(getService()),
        ),
        BlocProvider(
...
class InvC8ScreenBody extends StatefulWidget {
  const InvC8ScreenBody({super.key, required this.fromName});
  final String fromName;
  @override
  State<InvC8ScreenBody> createState() => _InvC8ScreenBodyState();
}

class _InvC8ScreenBodyState extends State<InvC8ScreenBody> {
